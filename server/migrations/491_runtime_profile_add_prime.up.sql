...
-- 491 is above every version currently on main.  440, 441, 444, 446, 451,
-- 457 and 468 were each free when this migration was renumbered onto them,
...
-- 457_task_message_output_truncated (#8212), and 468 by
-- 468_drop_reference_only_column (#8253).  main now reaches 490, so 491 is
-- the next free prefix.  None of 442-490 is a family migration, so 441
