...
// 2.13.0 ACP smoke — see the call site. prime (Prime Agent v0.7.1) loads
// AGENTS.md from the session cwd, so it stays off this list too. Still
// unprobed: grok, qoder, codebuddy.
